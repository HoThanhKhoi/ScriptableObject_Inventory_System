...
namespace InventorySystem.UI.Screens.InventoryScreen
{
	...
	{
		[SerializeField] private InventorySlotView _weaponSlotView;
		[SerializeField] private InventorySlotView _skillGroup1SlotView;
		[SerializeField] private InventorySlotView _skillGroup2SlotView;
		[SerializeField] private InventorySlotView _consumableSlotView;

		[SerializeField] private InventoryZodiacPanelView _zodiacPanelView; // optional
		[SerializeField] private InventoryLeftPanelView _leftPanelView;
